...
public class JwtProvider {
    ...
    public TokenDto generateTokenDto(Authentication authentication,String refreshTokenKey){
        ...
        String reToken = createJwtRefreshToken(authentication.getName(),refreshTokenValue, authorities);
    ...
    public String createJwtRefreshToken(String userId, String value,  String roles){
        Claims claims = Jwts.claims().setSubject(userId);
    ...
    public String resolveJwtToken(HttpServletRequest request){return request.getHeader("Authorization");}
